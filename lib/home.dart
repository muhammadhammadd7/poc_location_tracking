...
//       if (isTracking) {
//         // App is going to background or being killed, ensure service keeps running
...
//   void onBackgroundService() {
//     Timer.periodic(const Duration(seconds: 5), (timer) async {
//       Position? position = await LocationService.getCurrentLocation();
//       if (position != null) {
//         final locationJson = json.encode(position.toJson());
//         await FlutterBackgroundService().sendData({
...
//   Future<void> initializeServices() async {
//     await FlutterBackgroundService.initialize(onBackgroundService);
//     _initForegroundTask();
//   }
